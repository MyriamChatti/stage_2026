...
from saliency.core.integrated_gradients import IntegratedGradients
...
#  DOSSIER SORTIE
# =========================
output_folder = "/home/myriam/Documents/stage_M2/Stage_2026/code/MASKCONTRAST/predictions_ig"
...
for img_name in image_files:
    ...
    save_path = os.path.join(output_folder, f"{img_name}_IG.png")
    cv2.imwrite(save_path, overlay)

print(" FINI : toutes les heatmaps sont générées")