...
output_folder = "/home/myriam/Documents/stage_M2/Stage_2026/code/MASKCONTRAST/xai_combo_results"
...
for file in os.listdir(input_folder):
    ...
    if file.endswith(".png"):
        ...
        # XRAI
        mask_xrai = xrai.GetMask(image, call_gradient)
        mask_xrai = normalize(mask_xrai)

        # combinaison robuste
        combined = np.median(
            [mask_gradcam, mask_smooth, mask_xrai],
            axis=0
        )
        ...
        save_path = os.path.join(
            output_folder,
            file.replace(".png","_xai_combo.png")
        )

        plt.savefig(save_path, bbox_inches="tight", pad_inches=0)
        plt.close()

print("Combinaison XAI terminée.")