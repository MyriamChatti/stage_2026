...
from saliency.core.guided_ig import GuidedIG
...
output_folder = "/home/myriam/Documents/stage_M2/Stage_2026/code/MASKCONTRAST/predictions_guided_ig"
...
for img_name in image_files:
    ...
    save_path = os.path.join(output_folder, f"{img_name}_GuidedIG.png")
    cv2.imwrite(save_path, overlay)

    print(f"Saved: {save_path}")

print("✅ Guided IG terminé")